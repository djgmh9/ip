...
public class Main extends Application {
    ...
    private Frenny frenny = new Frenny(projectDir + "/data/frenny.txt");
    ...
    private void handleUserInput() {
        ...
        String frennyText = frenny.getResponse(userInput.getText());
        dialogContainer.getChildren().addAll(
                DialogBox.getUserDialog(userText, userImage),
                DialogBox.getFrennyDialog(frennyText, frennyImage)
        );
        userInput.clear();
    }
}
